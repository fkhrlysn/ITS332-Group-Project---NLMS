<?php
		...
		$name = $staffid = $password = $phone = $email = $salary = $position = '';
		...
		$sql = "INSERT INTO staff (StaffID, StaffName, Pass, email, StaffNoPhone, StaffPosition, StaffSalary)
				VALUES ('$staffid', '$name', '$password', '$email', '$phone', '$position', '$salary')";
